...
function useUtcClock(intervalMs = 1000): string {
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-lg font-black tracking-wider text-white uppercase font-mono">Vanguard-Core</h1>
